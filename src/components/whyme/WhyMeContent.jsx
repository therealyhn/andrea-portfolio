...
export default function WhyMeContent({ heading, description, skills, buttonText, inView }) {
    return (
        <div className="whyme-content w-full md:w-1/2 lg:w-5/12 text-right text-text-light">
            ...
            {description && (
                <p className={`whyme-desc font-body text-text-light/80 text-lg sm:text-xl leading-relaxed mb-8 whitespace-pre-line transition-all duration-700 ${inView ? "animate__animated animate__fadeInUp animate__delay-1s" : "opacity-0 invisible"}`}>
