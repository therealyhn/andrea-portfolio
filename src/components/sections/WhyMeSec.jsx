...
export default function WhyMeSec() {
    ...
    return (
        <section
            id="whyme"
            ref={sectionRef}
            className="relative w-full py-20 md:py-32 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed"
            style={bgStyle}
        >
            {/* Red overlay tint */}
            <div className="absolute inset-0 bg-surface-soft/50 mix-blend-multiply" />
            <div className="absolute inset-0 bg-gradient-to-b from-surface-soft via-transparent to-background-dark" />
